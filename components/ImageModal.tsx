...
const ImageModal: React.FC<ImageModalProps> = ({ image, onClose, onDownload, onRemix, isLoading }) => {
      ...
      <div className="relative w-full h-full max-w-md max-h-[90vh] flex flex-col gap-4">
        ...
        <div className="flex justify-center gap-4">
          <button 
            ...
            className="flex items-center gap-2 bg-gray-700 hover:bg-gray-600 text-white font-semibold py-3 px-6 rounded-full transition-transform transform hover:scale-105"
          >
          ...
          <button 
            ...
            disabled={isLoading}
            className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 disabled:bg-indigo-900/50 disabled:cursor-not-allowed text-white font-semibold py-3 px-6 rounded-full transition-transform transform hover:scale-105"
          >
